...
// 编写各个状态类的实现，使用建立工厂StateFactory方式写，避免javascript中没有抽象类所带来的问题
var StateFactory=(function(){
    var State=function(){};
    State.prototype.clickHandler1=function(){
        console.log('子类必须重写父类的 clickHandler1 方法');
    }
    State.prototype.clickHandler2=function(){
        console.log('子类必须重写父类的 clickHandler2 方法');
    }
